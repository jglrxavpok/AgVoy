 ...
 */
final class Version20191025095246 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE client (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, email CLOB NOT NULL)');
        $this->addSql('CREATE TABLE indisponibility (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, start DATETIME NOT NULL, end_time DATETIME NOT NULL)');
